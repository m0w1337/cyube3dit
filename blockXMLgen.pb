...
SetXMLAttribute(item, "texture0", "straws.material")
...
SetXMLAttribute(item, "textype", "5")
SetXMLAttribute(item, "texture0", "flower1.material")

item = CreateXMLNode(mainNode, "AlphaBlock") 
SetXMLNodeText(item, "Flower 2") 
SetXMLAttribute(item, "id", "17")
SetXMLAttribute(item, "textype", "5")
SetXMLAttribute(item, "texture0", "flower2.material")
...
SetXMLAttribute(item, "textype", "5")
SetXMLAttribute(item, "texture0", "flower3.material")
...
SetXMLAttribute(item, "textype", "5")
SetXMLAttribute(item, "texture0", "flower4.material")
...
SetXMLAttribute(item, "textype", "5")
SetXMLAttribute(item, "texture0", "Rainbowflower.material")
...
item = CreateXMLNode(mainNode, "AlphaBlock") 
SetXMLNodeText(item, "Glass") 
SetXMLAttribute(item, "id", "89")
SetXMLAttribute(item, "textype", "1")
SetXMLAttribute(item, "texture0", "Glass.material")
; Save the xml into a xml file
SaveXML(xml, "D:\m0\INGb\projekte\cyube3dit\blocks.xml")
